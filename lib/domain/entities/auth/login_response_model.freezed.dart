...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  const _$LoginResponseModelImpl(
      ...
      @JsonKey(name: 'user') this.userModel});
  ...
  @override
  String toString() {
    return 'LoginResponseModel(status: $status, message: $message, token: $token, userModel: $userModel)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, message, token, userModel);
