...
abstract class $PaymentStatusModelCopyWith<$Res> {
  factory $PaymentStatusModelCopyWith(
          PaymentStatusModel value, $Res Function(PaymentStatusModel) then) =
      _$PaymentStatusModelCopyWithImpl<$Res, PaymentStatusModel>;
  @useResult
  $Res call({@JsonKey(name: 'payment_status') String? statusPayment});
}
...
class _$PaymentStatusModelImpl implements _PaymentStatusModel {
  const _$PaymentStatusModelImpl(
      {@JsonKey(name: 'payment_status') this.statusPayment});
...
// TODO : Need to adjust if the respose is okay
  ...
  @override
  String toString() {
    return 'PaymentStatusModel(statusPayment: $statusPayment)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, statusPayment);
...
abstract class _PaymentStatusModel implements PaymentStatusModel {
  const factory _PaymentStatusModel(
          {@JsonKey(name: 'payment_status') final String? statusPayment}) =
