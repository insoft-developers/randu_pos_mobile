...
import 'widget/loading/expenditure_data_loading_mobile.dart';

class ExpenditureDataPageMobile extends ConsumerStatefulWidget {
  const ExpenditureDataPageMobile({super.key});

  @override
  ConsumerState<ExpenditureDataPageMobile> createState() =>
      _ExpenditureDataPageMobileState();
}

class _ExpenditureDataPageMobileState
    extends ConsumerState<ExpenditureDataPageMobile> {
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: CustomRoundedContainer(
                            ...
                            child: DropdownButton(
                              ...
                              iconSize: 20,
                              value: expenseProvider.value?.selectedMonth,
                              items: months.map((e) {
                              ...
                              onChanged: (value) {
                                if (expenseProvider.value?.selectedYear !=
                                        null &&
                                    value != null) {
                                  ref
                        ...
                        Expanded(
                          child: CustomRoundedContainer(
                            ...
                            child: DropdownButton(
                              ...
                              iconSize: 20,
                              value: expenseProvider.value?.selectedYear,
                              items: years.map((e) {
                                return DropdownMenuItem(
                                  value: e,
                                  child: Text(e,
                              ...
                              onChanged: (value) {
                                if (expenseProvider.value?.selectedMonth !=
                                        null &&
                                    value != null) {
                                  ref
                                      .read(getOutletExpenseProvider.notifier)
                    ...
                    expenseProvider is AsyncLoading &&
                        ...
                        ? const Expanded(child: ExpenditureDataLoadingMobile())
