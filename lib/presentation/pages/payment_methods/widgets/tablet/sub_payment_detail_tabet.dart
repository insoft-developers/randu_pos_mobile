...
import 'detail_bank_payment_tablet.dart';
import 'detail_cash_payment_tablet.dart';
import 'detail_payment_gateway_payment_tablet.dart';
import '../sub_payment_method_card.dart';
import 'detail_qris_payment_tablet.dart';

class SubPaymentDetailTabet extends ConsumerWidget {
  const SubPaymentDetailTabet({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return isTunai
        ? const DetailCashPaymentTablet()
        : isPaymentGateway
            ? const DetailPaymentGatewayPaymentTablet()
            : isBank
                ? DetailBankPaymentTablet()
                : isPiutang
                    ? SubPaymentDetailOld()
                    : isQris
                        ? const DetailQrisPaymentTablet()
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CustomRoundedContainer(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Pembayaran ${paymentMethodSelection.paymentMethod?.method ?? '-'}',
